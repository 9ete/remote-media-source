#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# rms-consumer-1 Lando setup (simulates a local dev environment)
...
SITE_URL="https://rms-consumer-1.lndo.site"
SITE_TITLE="RMS Consumer 1 (Local Dev)"
...
// Without this, Test Connection fails with SSL verification errors.
